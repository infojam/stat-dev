<script>
  ...
  import Launch from 'carbon-icons-svelte/lib/Launch.svelte';
	...
	import { DotMark } from 'carbon-icons-svelte';
</script>

<div>
	<ProjectHeader name="H&S Officer" category="Resources" sub_category="Health and Safety" job_id="123"/>
	<br /><br />
</div>
...
<div class="bootstrap-wrapper grayband">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-3"><Tile light style="box-shadow: 0px 2px 2px #E3E3E3;" > <h6>Evaluations</h6>
            
            

                <ul>
                    <li><DotMark style="color:#d1d1d1;"/><Link href="">17/09/2023</Link></li>
                    <li><DotMark style="color:#f4c416;"/><Link href="">09/09/2023</Link></li>
                    <li><DotMark style="color:#3d7d40;"/><Link href="">24/04/2022</Link></li>
                    <li><DotMark style="color:#a2191f;"/><Link href="">01/01/2021</Link></li>
                </ul>
            ...
            <div class="col-md-9"><Tile light style="box-shadow: 0px 2px 2px #E3E3E3;" ><h6>Most recent evaluation</h6>
            
                <Tabs autoWidth  style="display: flex;align-items:right;justify-content:right;padding-top:1rem;">
                    <Tab label="Scores" />
                    ...
                    <svelte:fragment slot="content">
                      <TabContent>
                        ...
                        <dl>
                            ...
                            <dd style="padding-bottom: 1rem;">Tyrone May</dd>
                            <dt style="font-size:0.7rem;color:gray;">Grade</dt>
                            <dd style="padding-bottom: 1rem;">Grade 3</dd>
                          <dt style="font-size:0.7rem;color:gray;">Score</dt>
                            <dd style="padding-bottom: 1rem;">345</dd>
...
<table>
    <thead>
        ...
        <th class="score_head">
            <TooltipDefinition
  tooltipText="Supervision & Management"
>
  S&M
</TooltipDefinition>
        </th>
    ...
    <tbody>
        <tr>
            <td style="padding-right: 10px;">M Lewi...</td>
        ...
        <tr>
            <td style="padding-right: 10px;">A Vete</td>
            <td> <Tag size="sm" type="green">4</Tag></td>
            <td> <Tag size="sm" type="green">4</Tag></td>
            <td> <Tag size="sm" type="green">4</Tag></td>
            <td> <Tag size="sm" type="green">4</Tag></td>
        ...
        <tr>
            <td style="padding-right: 10px;">K Linn...</td>
            <td> <Tag size="sm" type="green">4</Tag></td>
            <td> <Tag size="sm" type="green">4</Tag></td>
            <td> <Tag size="sm" type="green">4</Tag></td>
            <td> <Tag size="sm" type="green">4</Tag></td>
